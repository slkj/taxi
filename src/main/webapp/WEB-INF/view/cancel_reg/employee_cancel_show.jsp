	...
	<div style="margin-top: 20px;" id="zhongxin">
		<table style="table-layout: fixed;" id="table_report" border="1"
			class="table table-striped table-bordered table-hover">
					...
					<%-- <c:forEach items="${files }" var="varlist" varStatus="vs">
					<tr>
						<td colspan="2" class="center" style="vertical-align:middle;">报废单附件${vs.index + 1}:</td>
						<td colspan="6" class="center" style="vertical-align:middle;">
							<c:if test="${varlist != null && varlist.PATH != '' && varlist.PATH != null }">
								<a href="<%=basePath%>uploadFiles/uploadImgs/${varlist.PATH}" target="_blank"><img src="<%=basePath%>uploadFiles/uploadImgs/${varlist.PATH}" width="210"/></a>
							</c:if>
						</td>
					</tr>
					</c:forEach> --%>
