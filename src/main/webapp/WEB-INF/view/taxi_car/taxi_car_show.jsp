...
<body>
		...
		<tr>
			  <td colspan="3"><span
				...
				style="margin-left: 2px;">${pd.fileNum }</span></td>
			<td colspan="3"><span
				style="margin-left: 20px;">车主姓名：</span> <span
				style="margin-left: 2px;">${pd.ownerName }</span></td>
			<td colspan="2">
          ...
          <tr>
			 <td colspan="3">
              <span style="margin-left:20px;">营运证号：</span>
                    <span style="margin-left:2px;">${pd.opretaCertNum }</span>
            </td>
            <td colspan="3">
              <span style="margin-left:20px;">原车主：</span>
                    <span style="margin-left:2px;">${pd.origOwnerName }</span>
            </td>
            <td colspan="2">
            <span style="margin-left:20px;">车型：</span>
                    <span style="margin-left:2px;">${pd.sign }</span>
          ...
          <tr>
            <td colspan="3">
              <span style="margin-left:4px;">公司名称：</span>
                    <span style="margin-left:2px;">${pd.corpName }</span>
            </td>
            <td colspan="3">
              <span style="margin-left:20px;">联系电话：</span>
                    <span style="margin-left:2px;">${pd.phoneNum }</span>
            </td>
            <td colspan="2">
              <span
				style="margin-left: 20px;">车身颜色：</span> <span
				style="margin-left: 2px;">${pd.color }</span>
            </td>
          </tr>
          <tr>
            <td colspan="8">
              <span style="margin-left:20px;">变更日期：</span>
                    <span style="margin-left:2px;">${pd.transferDate }</span>
              <span style="margin-left:20px;">变更记录：</span>
                    <span style="margin-left:2px;">${pd.ownerChange }</span>
              <span style="margin-left:20px;">查封记录：</span>
                    <span style="margin-left:2px;">${pd.sealRecord }</span>
            </td>
          </tr>
          <tr>
            <td colspan="8">
              <span style="margin-left:20px;">车牌号：</span>
                    <span style="margin-left:2px;">${pd.plateNum }</span>
              <span style="margin-left:20px;">原车号：</span>
                    <span style="margin-left:2px;">${pd.origPlateNum }</span>
              <span style="margin-left:20px;">行驶证初次登记日期：</span>
                    <span style="margin-left:2px;">${pd.drvLicenseDate }</span>
            </td>
          </tr>
          <tr>
			<td colspan="4"><span
				style="margin-left: 20px;">身份证号：</span> <span
				style="margin-left: 2px;">${pd.iDNumber }</span></td>
          ...
          <tr>
            <td colspan="7">
              <span style="margin-left:20px;">家庭住址：</span>
                    <span style="margin-left:2px;">${pd.address }</span>
            </td>
          </tr>
          <tr>
          	<td colspan="7">
              <span style="margin-left:20px;">吨（座）位：</span>
                    <span style="margin-left:2px;">${pd.tonsSeat }</span>
              <span style="margin-left:20px;">长：</span>
                    <span style="margin-left:2px;">${pd.carLen }</span>
              <span style="margin-left:20px;">宽：</span>
                    <span style="margin-left:2px;">${pd.carWidth }</span>
              <span style="margin-left:20px;">高：</span>
                    <span style="margin-left:2px;">${pd.carHigh }</span>
            </td>
          </tr>
          <tr>
          	<td colspan="4">
              <span style="margin-left:20px;">车架号：</span>
                    <span style="margin-left:2px;">${pd.frameNumber }</span>
            </td>
            <td colspan="3">
              <span style="margin-left:20px;">发动机号：</span>
                    <span style="margin-left:2px;">${pd.engineNumber }</span>
            </td>
          </tr>
          <tr>
          <td colspan="5">
              <span style="margin-left:20px;">许可证号：</span>
                    <span style="margin-left:2px;">${pd.licenseKey }</span>
            </td>
          	<td colspan="6">
              <span style="margin-left:20px;">发证日期：</span>
                    <span style="margin-left:2px;">${pd.checkDate }</span>
            </td>
          </tr>
          <tr>
          <td colspan="11">
              <span style="margin-left:20px;">座位数：</span>
                    <span style="margin-left:2px;">${pd.seating }</span>
