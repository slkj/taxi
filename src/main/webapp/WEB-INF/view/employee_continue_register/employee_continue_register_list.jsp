			...
			return [ [ {
				...
				formatter : function(value, row, index) {
					if (value == 0) {
						...
						return '<div style="background-color:#3a87ad;text-align:center;color:#FFFFFF;">审核成功</div>';
					} else if (value == 2) {
						return '<div style="background-color:#356635;text-align:center;color:#FFFFFF;">审核失败</div>';
					}
				}
			}, {
				field : 'opt',
